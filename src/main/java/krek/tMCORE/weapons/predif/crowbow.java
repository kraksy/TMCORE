...
public class crowbow extends CustomWeapon {

    public Arrow arrow;

    public crowbow(String name, List<Component> lore, Material itemVisual, WeaponAbility ability, PlayerStats reqStats, Arrow arrow) {
